 ...
 // getting the user data from input:
  ...
  return (
    <div className='signup-container'>
      ...
      <div className='signup-auth-boxes'>
        ...
        <div className='auth-input-box'>
          ...
          <div className='user-input-box'>
            ...
            {userForRegData.email !='' && isEmailClicked === true ? (
      ...
      <button onClick={()=>UserSignUp()} disabled = {!isAllFieldsFilled} style={{opacity:`${isAllFieldsFilled ? '1' : '0.3'}`}} className={`${isAllFieldsFilled ? 'signup-auth-button cursor' : 'signup-auth-button'}`}>Signup</button>
